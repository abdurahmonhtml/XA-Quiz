...
export default function Dashboard() {
  ...
  const cardStyle = { padding: 32, cursor: 'pointer', borderRadius: 20, background: 'rgba(30,41,59,0.6)', border: '1px solid rgba(51,65,85,0.5)', transition: 'all 0.3s ease' };
    ...
    <div style={{ minHeight: '100vh', background: '#020617', fontFamily: fonts.body }}>
      ...
      <div style={{ padding: '32px 16px', maxWidth: 1200, margin: '0 auto' }}>
        <div style={{ marginBottom: 40 }}>
          <p style={{ color: '#10b981', fontSize: 13, fontWeight: 600, textTransform: 'uppercase', letterSpacing: 2, marginBottom: 8, fontFamily: fonts.display }}>⚡ Admin Panel</p>
          ...
          <p style={{ color: '#64748b', fontSize: 18, fontFamily: fonts.body }}>Test tuzing, yeching va reytingda o'z o'rningizni toping.</p>
        </div>

        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: 24, marginBottom: 40 }}>
          <div onClick={() => navigate('/create')} style={cardStyle} onMouseEnter={e => { e.currentTarget.style.borderColor = '#10b981'; e.currentTarget.style.transform = 'translateY(-4px)'; }} onMouseLeave={e => { e.currentTarget.style.borderColor = 'rgba(51,65,85,0.5)'; e.currentTarget.style.transform = 'translateY(0)'; }}>
          ...
          <div onClick={() => navigate('/solve')} style={cardStyle} onMouseEnter={e => { e.currentTarget.style.borderColor = '#f59e0b'; e.currentTarget.style.transform = 'translateY(-4px)'; }} onMouseLeave={e => { e.currentTarget.style.borderColor = 'rgba(51,65,85,0.5)'; e.currentTarget.style.transform = 'translateY(0)'; }}>
            <div style={{ fontSize: 40, marginBottom: 16 }}>🧠</div>
